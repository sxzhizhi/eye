<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Key_GLJG.aspx.vb" Inherits="Key_GLJG" %>
     ...
     <script type="text/javascript">
        ...
        function WinOpen(code, edit) {
            layer.open({
                ...
                title: ['管理机构信息'],
                type: 2,
                content: "frm_GLJG.aspx?UnitCode=" + code + "&UnitEdit=" + edit,
                area: ['800px', '60%'],
                shade: 0.3,
    ...
    <div class='span12 box bordered-box purple-border' style='margin-bottom:0;'>
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Code" HeaderText="系统编码" ReadOnly="True" SortExpression="Code" />
                                    <asp:BoundField DataField="SSXZQ" HeaderText="所属行政区" SortExpression="SSXZQ" />
            <asp:BoundField DataField="GLJGMC" HeaderText="管理机构名称" SortExpression="GLJGMC" />

                                    <asp:BoundField DataField="GLJG" HeaderText="管理机构账号" SortExpression="GLJG" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BNZXMConnectionString %>" SelectCommand="SELECT * FROM [GLJGB]"></asp:SqlDataSource>
