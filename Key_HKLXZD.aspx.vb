...
Partial Class Key_HKLXZD
    ...
    Private Sub NDZD_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Session("menu") = "户口类型字典"
        Session("onelevel") = "4"
        Session("twolevel") = "4.1"

        Me.SqlDataSource1.SelectCommand = "SELECT * FROM [DicHKLX]"
    ...
    Public Shared Function del(ByVal k1 As String) As String
        ...
        Else
            ...
            For i = 0 To arr.Length - 2
                cPConn.Execute("delete from DicHKLX where zHKLXcode='" & arr(i) & "'")

                '
                cPConn.Execute("insert into WaterLog(cUser,cAction,cRemark)values('" & HttpContext.Current.Session("userid") & "','删除户口类型字典数据!','" & arr(i) & "')")
    ...
    Private Sub GridView1_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            e.Row.Cells(3).Attributes.Add("onclick", cEdit)
