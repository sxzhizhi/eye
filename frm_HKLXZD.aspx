<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_HKLXZD.aspx.vb" Inherits="frm_HKLXZD" %>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label hor-form">
                                户口类型*</label>
                            <div class="col-sm-9">
                                <asp:TextBox ID="T_tslb" runat="server" CssClass="form-control" TabIndex="1" MaxLength="10"></asp:TextBox>
                            </div>
                        </div>
