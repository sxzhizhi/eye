<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_GLJG.aspx.vb" Inherits="frm_GLJG" %>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label hor-form">
                                所属行政区*</label>
                            <div class="col-sm-9">
                                <asp:DropDownList ID="cbo_SSXZQ" runat="server" CssClass="form-control"></asp:DropDownList>
                            ...
                            <label class="col-sm-2 control-label hor-form">
                                管理机构名称*</label>
                            <div class="col-sm-9">
                                <asp:TextBox ID="T_GLJGMC" runat="server" CssClass="form-control" TabIndex="1" MaxLength="15"></asp:TextBox>
                            </div>
                        </div>
                           <div class="form-group">
                            <label class="col-sm-2 control-label hor-form">
                                管理机构账号*</label>
                            <div class="col-sm-9">
                                <asp:TextBox ID="T_GLJG" runat="server" CssClass="form-control" TabIndex="1" MaxLength="15"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label hor-form">
