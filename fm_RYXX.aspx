<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fm_RYXX.aspx.vb" Inherits="TG_fm_RYXX" %>
    ...
    <form id="form1" runat="server">
        <div class="body">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label hor-form">
                                人员编号*</label>
                            <div class="col-sm-9">
                                <asp:TextBox ID="T_rycode" runat="server" CssClass="form-control" TabIndex="1" MaxLength="15"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label hor-form">
                                姓名*</label>
                            <div class="col-sm-9">
                                <asp:TextBox ID="T_xm" runat="server" CssClass="form-control" TabIndex="2" MaxLength="15"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label hor-form">
                                联系方式</label>
                            <div class="col-sm-9">
                                <asp:TextBox ID="T_lxfs" runat="server" CssClass="form-control" TabIndex="3" MaxLength="15"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label hor-form">
                                备注</label>
                            <div class="col-sm-9">
                                <asp:TextBox ID="T_bz" runat="server" CssClass="form-control" TabIndex="4" MaxLength="15"></asp:TextBox>
                            </div>
                        </div>
            ...
            <div class="col-sm-offset-2 col-sm-10">
                <asp:Button ID="But_Save" runat="server" Text="保存" CssClass="btn btn-success" TabIndex="5" />
                <%--<asp:Button ID="But_Close" runat="server" Text="关闭" CssClass="btn-default btn" OnClientClick="windowclose();" />--%>
                <asp:Button ID="but_LoadData" runat="server" Text="加载" CssClass="btn-inverse btn" TabIndex="6" />
            </div>
        </div>
    </form>
