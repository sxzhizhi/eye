...
Partial Class Key_BYZD
    ...
    Private Sub NDZD_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Session("menu") = "病因字典"
        Session("onelevel") = "4"
        Session("twolevel") = "4.2"

        Me.SqlDataSource1.SelectCommand = "SELECT * FROM [DicBY]"
    ...
    Public Shared Function del(ByVal k1 As String) As String
        ...
        Else
            ...
            For i = 0 To arr.Length - 2
                cPConn.Execute("delete from DicBY where zBYcode='" & arr(i) & "'")

                '
                cPConn.Execute("insert into WaterLog(cUser,cAction,cRemark)values('" & HttpContext.Current.Session("userid") & "','删除病因字典数据!','" & arr(i) & "')")
