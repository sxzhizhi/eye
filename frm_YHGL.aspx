<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_YHGL.aspx.vb" Inherits="frm_YHGL" %>
...
<body>
    <form id="form1" runat="server">
        <div class="">
            ...
            <div class="" style="margin: 0px; padding: 25px; text-align: center">
                <asp:Button ID="But_Save" runat="server" Text="保存" CssClass="btn btn-success" TabIndex="2" style="display:none" />
                <%--<asp:Button ID="But_Close" runat="server" Text="关闭" CssClass="btn-default btn" OnClientClick="windowclose();" />--%>
                <asp:Button ID="but_LoadData" runat="server" Text="加载" CssClass="btn-inverse btn" TabIndex="3" style="display:none"/>
                <asp:Button ID="Button1" runat="server" Text="初始化密码" CssClass="btn btn-success" />
            </div>
