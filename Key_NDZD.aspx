<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Key_NDZD.aspx.vb" Inherits="Key_NDZD" %>
     ...
     <script type="text/javascript">
        ...
        function WinOpen(code, edit) {
            layer.open({
                ...
                title: ['年度字典'],
                type: 2,
                content: "frm_NDZD.aspx?UnitCode=" + code + "&UnitEdit=" + edit,
                area: ['800px', '60%'],
                shade: 0.3,
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class='span12 box bordered-box green-border' style='margin-bottom:0;'>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="zNDCode" DataSourceID="SqlDataSource1" CssClass ="table table-bordered table-hover table-striped" AllowPaging="True">
        <Columns>
            ...
            <asp:BoundField DataField="zNDCode" HeaderText="系统编码" ReadOnly="True" SortExpression="zNDCode" />
            <asp:BoundField DataField="zNDName" HeaderText="项目年度" SortExpression="zNDName" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BNZXMConnectionString %>" SelectCommand="SELECT * FROM [DicND]"></asp:SqlDataSource>
