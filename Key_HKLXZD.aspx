<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Key_HKLXZD.aspx.vb" Inherits="Key_HKLXZD" %>
     ...
     <script type="text/javascript">
        ...
        function WinOpen(code, edit) {
            layer.open({
                ...
                title: ['户口类型字典'],
                type: 2,
                content: "frm_HKLXZD.aspx?UnitCode=" + code + "&UnitEdit=" + edit,
                area: ['800px', '60%'],
                shade: 0.3,
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class='span12 box bordered-box green-border' style='margin-bottom:0;'>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="zHKLXCode" DataSourceID="SqlDataSource1" CssClass ="table table-bordered table-hover table-striped" AllowPaging="True">
        <Columns>
            ...
            <asp:BoundField DataField="zHKLXCode" HeaderText="系统编码" ReadOnly="True" SortExpression="zHKLXCode" />
            <asp:BoundField DataField="zHKLXName" HeaderText="户口类型" SortExpression="zHKLXName" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BNZXMConnectionString %>" SelectCommand="SELECT * FROM [DicHKLX]"></asp:SqlDataSource>
