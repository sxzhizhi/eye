<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fm_HSXX.aspx.vb" Inherits="TG_fm_HSXX" %>
    ...
    <form id="form1" runat="server">
        <div class="body">
            <div class="container">
                <div class="tab-group">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <asp:TextBox  ID="T_xm" runat="server" class="form-control" AutoPostBack="True" TabIndex="2"  ReadOnly="true">
               ...
               <input id="Time_jsrq" class="layui-input" onclick="layui.laydate({ elem: this, istime: true, format: 'YYYY-MM-DD ' })" runat="server" tabindex="4" style ="margin-left :15px;"/></div>
                        ...
                        <div class="form-group" runat="server">
                            <label class="col-sm-2 control-label hor-form">
                                还书日期*</label>
                            <div class="layui-inline">
               <input id="Time_hsrq" class="layui-input" onclick="layui.laydate({ elem: this, istime: true, format: 'YYYY-MM-DD ' })" runat="server" tabindex="5" style ="margin-left :15px;"/></div>
