<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Key_YHGL.aspx.vb" Inherits="Key_YHGL" %>
     ...
     <script type="text/javascript">
        ...
        function WinOpen(code, edit) {
            layer.open({
                ...
                title: ['管理机构信息'],
                type: 2,
                content: "frm_YHGL.aspx?UnitCode=" + code + "&UnitEdit=" + edit,
                area: ['800px', '60%'],
                shade: 0.3,
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class='span12 box bordered-box purple-border' style='margin-bottom:0;'>
        ...
        <div class='box-content box-no-padding'>
                ...
                <div class='scrollable-area'>
                        ...
                        <div style="float: right; margin-right: 20px; margin-top :20px;">
                            ...
                            <asp:Button ID="but_init" runat="server" Text="初始" Width="144px" style=" display:none"/>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id,cName,cDeptCode" DataSourceID="SqlDataSource1" CssClass ="table table-bordered table-hover table-striped" AllowPaging="True">
        <Columns>
            ...
            <asp:BoundField DataField="cCode" HeaderText="系统编码" ReadOnly="True" SortExpression="cCode" />
            <asp:BoundField DataField="cName" HeaderText="账号" ReadOnly="True" SortExpression="cName" />


                                                <asp:BoundField DataField="GLJGMC" HeaderText="管理机构" SortExpression="GLJGMC" />
            <asp:BoundField DataField="DDJGMC" HeaderText="定点机构" SortExpression="DDJGMC" />
                                    <asp:TemplateField>
                                    <ItemTemplate>
                                        <input id="btn_modify" type="button" value="初始" style="background :deepskyblue;color:white;width:73px;" class="btn btn-primary" />
                                    </ItemTemplate>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BNZXMConnectionString %>" SelectCommand="SELECT * FROM [dbUserView]"></asp:SqlDataSource>
