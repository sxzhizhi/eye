<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Key_BYZD.aspx.vb" Inherits="Key_BYZD" %>
     ...
     <script type="text/javascript">
        ...
        function WinOpen(code, edit) {
            layer.open({
                ...
                title: ['病因字典'],
                type: 2,
                content: "frm_BYZD.aspx?UnitCode=" + code + "&UnitEdit=" + edit,
                area: ['800px', '60%'],
                shade: 0.3,
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class='span12 box bordered-box green-border' style='margin-bottom:0;'>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="zBYCode" DataSourceID="SqlDataSource1" CssClass ="table table-bordered table-hover table-striped" AllowPaging="True">
        <Columns>
            ...
            <asp:BoundField DataField="zBYCode" HeaderText="系统编码" ReadOnly="True" SortExpression="zBYCode" />
            <asp:BoundField DataField="zBYName" HeaderText="病因" SortExpression="zBYName" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BNZXMConnectionString %>" SelectCommand="SELECT * FROM [DicBY]"></asp:SqlDataSource>
