...
Partial Class Key_NDZD
    ...
    Private Sub NDZD_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Session("menu") = "年度字典"
        Session("onelevel") = "4"
        Session("twolevel") = "4.3"

        Me.SqlDataSource1.SelectCommand = "SELECT * FROM [DicND]"
    ...
    Public Shared Function del(ByVal k1 As String) As String
        ...
        Else
            ...
            For i = 0 To arr.Length - 2
                cPConn.Execute("delete from DicND where zNDcode='" & arr(i) & "'")

                '
                cPConn.Execute("insert into WaterLog(cUser,cAction,cRemark)values('" & HttpContext.Current.Session("userid") & "','删除年度字典数据!','" & arr(i) & "')")
