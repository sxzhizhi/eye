...
Partial Class Key_YHGL
    ...
    Private Sub NDZD_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Session("menu") = "用户管理"
        Session("onelevel") = "5"
        Session("twolevel") = "5.3"

        Me.SqlDataSource1.SelectCommand = "SELECT * FROM [dbUserview] where cName<>'system'"
        If IsPostBack = False Then
            Call bind()
        End If

        '检测表内是否有信息
        rs = cPConn.Execute("select * from [dbUserview] where cName<>'system'")
    ...
    Public Shared Function del(ByVal k1 As String) As String
        ...
        Else
            ...
            For i = 0 To arr.Length - 2
                ...
                rs = cPConn.Execute("Select * from HZXXB where JGBH='" & arr(i) & "'")

                If rs.RecordCount = 0 Then
                    cPConn.Execute("delete from dbUser where cCode='" & arr(i) & "'")
                    '
                    cPConn.Execute("insert into WaterLog(cUser,cAction,cRemark)values('" & HttpContext.Current.Session("userid") & "','删除用户数据!','" & arr(i) & "')")
                Else
                    Return "该账号有信息存在，不能删除，请删除数据后再试！"
                    Exit Function
                End If
            Next
    ...
    Private Sub GridView1_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            cEdit = "javascript:WinOpen1('" & cCode & "');"
