<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fm_YHGL.aspx.vb" Inherits="TG_fm_YHGL" %>
    ...
    <form id="form1" runat="server">
        <div class="body">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label hor-form">
                                用户名*</label>
                            <div class="col-sm-9">
                                <asp:TextBox ID="T_name" runat="server" CssClass="form-control" TabIndex="1" MaxLength="15"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label hor-form">
                                备注</label>
                            <div class="col-sm-9">
                                <asp:TextBox ID="T_bz" runat="server" CssClass="form-control" TabIndex="2" MaxLength="15"></asp:TextBox>
                            </div>
                        </div>
            ...
            <div class="col-sm-offset-2 col-sm-10">
                <asp:Button ID="But_Save" runat="server" Text="保存" CssClass="btn btn-success" TabIndex="3" />
                <%--<asp:Button ID="But_Close" runat="server" Text="关闭" CssClass="btn-default btn" OnClientClick="windowclose();" />--%>
                <asp:Button ID="but_LoadData" runat="server" Text="加载" CssClass="btn-inverse btn" TabIndex="4" />
            </div>
        </div>
    </form>
