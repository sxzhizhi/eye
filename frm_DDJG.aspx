<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_DDJG.aspx.vb" Inherits="frm_DDJG" %>
    ...
    <form id="form1" runat="server">
        <div class="body">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label hor-form">
                                所属管理机构*</label>
                            <div class="col-sm-9">
                                <asp:DropDownList ID="cbo_SSGLJG" runat="server" CssClass="form-control"></asp:DropDownList>
                            ...
                            <label class="col-sm-2 control-label hor-form">
                                定点机构名称*</label>
                            <div class="col-sm-9">
                                <asp:TextBox ID="T_DDJGMC" runat="server" CssClass="form-control" TabIndex="1" MaxLength="15"></asp:TextBox>
                            </div>
                        </div>
                           <div class="form-group">
                            <label class="col-sm-2 control-label hor-form">
                                定点机构账号*</label>
                            <div class="col-sm-9">
                                <asp:TextBox ID="T_DDJG" runat="server" CssClass="form-control" TabIndex="1" MaxLength="15"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label hor-form">
                                备注</label>
                            <div class="col-sm-9">
                                <asp:TextBox ID="T_BZ" runat="server" CssClass="form-control" TabIndex="1" MaxLength="0"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-offset-2 col-sm-10">
                ...
                <asp:Button ID="but_LoadData" runat="server" Text="加载" CssClass="btn-inverse btn" TabIndex="3" />
            </div>
        </div>
    </form>
